        ...
        <form action="./Controlador" method="post">
            ...
            <div class="mb-3">
                <input type="text" name="username" class="form-control" placeholder="Nombre de Usuario"
                    pattern="[a-zA-Z ,.'-]{3,48}" title="Debe tener entre 3 y 48 letras" required />
            </div>
            <div class="mb-3">
                <input type="email" name="correo" class="form-control" placeholder="Correo"
                    title="Debe ser un correo valido" required />
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <input type="text" name="numeroTarjeta" class="form-control"
                    placeholder="Numero de Tarjeta" pattern="[0-9]{10,20}"
                    title="Debe tener entre 10 y 20 digitos" required />
            </div>
            <div class="mb-3">
                <input type="password" name="password" class="form-control" placeholder="Password"
                    pattern="(?=.*\d)(?=.*[A-Z]).{8,}"
                    title="Debe tener al menos 8 caracteres, una mayuscula y un numero" required />
            </div>


            <input type="submit" name="confirmarRegistro" class="btn btn-outline-primary"
                value="Registrarse" style="margin-top: 10px;margin-bottom: 10px;" />
